<div class="modal fade" id="AddProductModal" tabindex="-1" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" name="submit_product" id="submit_product" autocomplete="false">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 mb-3">
                            <label for="sku" class="form-label">SKU</label>
                            <input type="text" class="form-control" name="sku" id="sku" autocomplete="off" required autofocus>
                        ...
                        <div class="col-lg-12 col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="lokasi" id="lokasi" autocomplete="off" required autofocus>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-lg-12 col-md-12 mb-3">
